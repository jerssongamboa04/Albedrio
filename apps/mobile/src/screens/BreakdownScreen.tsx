...
import { buildTaskBreakdown } from "../services/breakdown.service";

type Props = NativeStackScreenProps<AppStackParamList, "BreakdownScreen">;
...
export function BreakdownScreen({ route, navigation }: Props) {
  ...
  const breakdown = useMemo(() => {
    if (!task) return null;
    return buildTaskBreakdown(task);
  }, [task]);
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.notFoundWrap}>
          ...
          <Text style={styles.notFoundTitle}>
            No hemos podido preparar esta descomposición
          </Text>
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.eyebrow}>Descomposición de tarea</Text>
          <Text style={styles.heroTitle}>{breakdown.headline}</Text>
          <Text style={styles.heroSubtitle}>{breakdown.message}</Text>
        </View>
        ...
        <View style={styles.card}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>Tres pasos para verla más clara</Text>
          </View>
        ...
        <View style={styles.footerActions}>
          ...
          <Pressable style={styles.primaryButton} onPress={handleStartTask}>
            <Ionicons name="play-outline" size={18} color="#FFFFFF" />
            <Text style={styles.primaryButtonText}>Empezar con esto</Text>
          </Pressable>
        </View>
      </ScrollView>
    </SafeAreaView>
